...
public class DriveablePart extends Entity {
	...
	public DriveablePart(World worldIn) {
		super(worldIn);
	}
	...
	public void setDriveable(EntityDriveable driveable) {
		this.driveable = driveable;
		this.setPosition(driveable.posX, driveable.posY, driveable.posZ);
	}
	...
	public void updatePosition() {
		...
		Vector3f localPosition = new Vector3f(box.x / 16F, box.y / 16F, box.z / 16F);
		...
		{
			FlansMod.log.warn("Part was made to move stupid distance in a frame, cancelling");
		}
		else
		{
			// Set the absol
